...
print("GENERANDO GRÁFICAS COMPARATIVAS PARA JUEVES...")

# --- 1. CARGA Y LIMPIEZA DE DATOS ---
try:
    # 1. Datos Reales
    real_file = 'jueves_hora.csv'
    if not os.path.exists(real_file) and os.path.exists('Jueves_Hora.csv'):
        real_file = 'Jueves_Hora.csv'
    ...
    # 2. Datos Simulados
    sim_file = 'Resultados_PPO_Jueves_1H_Final.csv' 
...
plt.title('Perfil Diario Promedio - Jueves (1H)', fontsize=16, fontweight='bold')
...
plt.tight_layout()
plt.savefig('validacion_modelo_perfil_diario_jueves_1h.png', dpi=300)
...
for i, year in enumerate(years):
    ...
    if not data_year.empty:
        ...
        ax.set_title(f'Perfil Jueves - Año {year}', fontweight='bold', fontsize=14)
...
plt.xlabel('Hora del Día', fontsize=14, fontweight='bold')
plt.tight_layout()
plt.savefig('validacion_modelo_por_anio_jueves_1h.png', dpi=300)
print("Gráfica 2 lista.")
plt.close()

# ==========================================
# GRÁFICA 3: SERIE TEMPORAL (JUEVES A JUEVES)
# ==========================================
...
plt.title('Validación del Modelo - Serie Temporal Completa - Jueves 1H', fontsize=16, fontweight='bold')
...
plt.tight_layout()
plt.savefig('validacion_modelo_serie_temporal_jueves_1h.png', dpi=300)
print("Gráfica 3 lista.")
plt.close()

print("\n Gráficas de Jueves generadas.")
