...
print("\n" + "="*80)
print("**SIMULACION DEL DIA MARTES (ESCENARIO 15 MINUTOS)**")
print("="*80 + "\n")
...
FINAL_FILE = '/home/vboxuser/Descargas/EDIFICIO_MARTES_15MIN.epJSON' 
EPW_FILE = '/home/vboxuser/Descargas/Guayaquilcl2023.epw' 

LOG_DIR = "./logs_martes_15min/"
MODEL_DIR = "./modelos_martes_15min/"
os.makedirs(LOG_DIR, exist_ok=True)
os.makedirs(MODEL_DIR, exist_ok=True)

CSV_OBJETIVO = 'Martes.csv' 
...
try:
    if os.path.exists(CSV_OBJETIVO):
        ...
        # Filtro Martes (weekday=1)
        df_dia = df_real[df_real['Timestamp'].dt.dayofweek == 1]
...
def main():
    ...
    # =====================================================================
    print("Fase 1: Entrenamiento del agente PPO (Martes 15 min)...")
    ...
    print("\n" + "="*80)
    print("Resultados guardados: Resultados_PPO_Martes_15Min_Final.csv")
    print("="*80)
