...
print("\n" + "="*80)
print("**SIMULACION DEL DIA LUNES (ESCENARIO 15 MINUTOS)**")
print("="*80 + "\n")
...
FINAL_FILE = '/home/vboxuser/Descargas/EDIFICIO_LUNES_15MIN.epJSON' 
EPW_FILE = '/home/vboxuser/Descargas/Guayaquilcl2023.epw' 

LOG_DIR = "./logs_lunes_15min/"
MODEL_DIR = "./modelos_lunes_15min/"
os.makedirs(LOG_DIR, exist_ok=True)
os.makedirs(MODEL_DIR, exist_ok=True)

CSV_OBJETIVO = 'LunesVF.csv' 
...
try:
    if os.path.exists(CSV_OBJETIVO):
        ...
        df_dia = df_real[df_real['Timestamp'].dt.dayofweek == 0]
...
def main():
    ...
    # =====================================================================
    print("Fase 1: Entrenamiento del agente PPO (Lunes 15 min)...")
    ...
    try:
        while current_date <= end_date:
            ...
            # Solo se registran datos correspondientes a Lunes (weekday=0)
    ...
    df.to_csv('Resultados_PPO_Lunes_15Min_Final.csv', index=False)
    
    print("\n" + "="*80)
    print("Resultados guardados: Resultados_PPO_Lunes_15Min_Final.csv")
    print("="*80)
