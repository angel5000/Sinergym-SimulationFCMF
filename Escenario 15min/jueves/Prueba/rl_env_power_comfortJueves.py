...
print("\n" + "="*80)
print("**SIMULACION DEL DIA JUEVES (ESCENARIO 15 MINUTOS)**")
print("="*80 + "\n")
...
FINAL_FILE = '/home/vboxuser/Documentos/EDIFICIO_JUEVES_15MIN.epJSON' 
EPW_FILE = '/home/vboxuser/Documentos/Guayaquilcl2023.epw' 

LOG_DIR = "./logs_jueves_15min/"
MODEL_DIR = "./modelos_jueves_15min/"
os.makedirs(LOG_DIR, exist_ok=True)
os.makedirs(MODEL_DIR, exist_ok=True)

CSV_OBJETIVO = 'Jueves.csv' 
...
class PowerComfortEnv15Min(Env):
    ...
    def __init__(self, building_file, weather_file, target_dict, 
                 runperiod=(4, 11, 2021, 30, 12, 2022), 
    ...
    def step(self, action):
        ...
        # Penalizacion lineal de confort
        t_norm = diff_t
...
def main():
    ...
    # =====================================================================
    print("Fase 1: Entrenamiento del agente PPO (Jueves 15 min)...")
    ...
    model.save("PPO_Agente_Jueves_15Min")
    
    # =====================================================================
    # FASE 2: GENERACION DEL DATASET DE RESULTADOS
    # =====================================================================
    print("\nGenerando CSV Jueves 15 min...")
    try: vec_env.env_method("close")
    except: pass
    
    obs = vec_env.reset()
    current_date = datetime(2021, 11, 4, 0, 0, 0)
    
    # FIN BUCLE: 23:50 para asegurar captura del último intervalo
    end_date = datetime(2022, 12, 30, 23, 50, 0) 
    ...
    df.to_csv('Resultados_PPO_Jueves_15Min_Final.csv', index=False)
    
    print("\n" + "="*80)
    print("Resultados guardados: Resultados_PPO_Jueves_15Min_Final.csv")
    print("="*80)
