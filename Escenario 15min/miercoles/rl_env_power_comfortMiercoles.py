...
print("\n" + "="*80)
print("**SIMULACION DEL DIA MIERCOLES (ESCENARIO 15 MINUTOS)**")
print("="*80 + "\n")
...
FINAL_FILE = '/home/vboxuser/Documentos/EDIFICIO_MIERCOLES_15MIN.epJSON' 
EPW_FILE = '/home/vboxuser/Documentos/Guayaquilcl2023.epw' 

LOG_DIR = "./logs_miercoles_15min/"
MODEL_DIR = "./modelos_miercoles_15min/"
os.makedirs(LOG_DIR, exist_ok=True)
os.makedirs(MODEL_DIR, exist_ok=True)

CSV_OBJETIVO = 'Miercoles.csv' 
...
def main():
    ...
    # =====================================================================
    print("Fase 1: Entrenamiento del agente PPO (Miercoles 15 min)...")
    ...
    model.save("PPO_Agente_Miercoles_15Min")
    
    # =====================================================================
    # FASE 2: GENERACION DEL DATASET DE RESULTADOS
    # =====================================================================
    print("\nGenerando CSV Miercoles 15 min...")
    try: vec_env.env_method("close")
    except: pass
    
    obs = vec_env.reset()
    current_date = datetime(2021, 9, 5, 0, 0, 0)
    
    # FIN BUCLE: 23:50 para asegurar captura del último intervalo
    end_date = datetime(2023, 8, 30, 23, 50, 0) 
    ...
    df.to_csv('Resultados_PPO_Miercoles_15Min_Final.csv', index=False)
    
    print("\n" + "="*80)
    print("Resultados guardados: Resultados_PPO_Miercoles_15Min_Final.csv")
    print("="*80)
